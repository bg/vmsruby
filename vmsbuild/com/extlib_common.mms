...
.C.OBJ
    ...
    $(CC)$(CFLAGS)$(HAVEFUNCFLAGS)$(USER_CFLAGS) TMPSRC$:'F$PARSE("$(MMS$SOURCE)",,,"NAME")'
...
LINKSHRFLAGS=-
/SHAREABLE=$(MMS$TARGET)/MAP=LIS$:'F$PARSE("$(MMS$TARGET)",,,"NAME")'.MAP/FULL/CROSS

LINKEXEFLAGS=-
/EXECUTABLE=$(MMS$TARGET)/MAP=LIS$:'F$PARSE("$(MMS$TARGET)",,,"NAME")'.MAP/FULL/CROSS
